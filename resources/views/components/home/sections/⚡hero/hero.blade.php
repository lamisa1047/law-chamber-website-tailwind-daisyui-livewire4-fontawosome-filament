<!-- ══════════ HERO ══════════ -->
  <style>
    ...
    .float-icon-delay { animation: float 3s ease-in-out 1.5s infinite; }
...
<!-- ════════════════════════════════════
     HERO SECTION
════════════════════════════════════ -->
<section class="hero-bg relative overflow-hidden bg-forest min-h-[580px]">

  <!-- Corner accent lines -->
  {{-- <div class="absolute top-0 left-0 w-24 h-24 border-t-2 border-l-2 border-gold/30 rounded-tl-3xl pointer-events-none"></div>
  <div class="absolute bottom-0 right-0 w-24 h-24 border-b-2 border-r-2 border-gold/30 rounded-br-3xl pointer-events-none"></div> --}}
  ...
  <!-- ── Main grid ── -->
  <div class="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-[580px] px-6 py-10 md:px-12 md:py-14 lg:px-16">
    ...
    <div class="flex flex-col justify-center space-y-6 order-2 lg:order-1">
      ...
      <div class="slide-up delay-100 flex items-center gap-2">
        ...
        <span class="text-gold text-xs font-body uppercase tracking-[.2em] font-semibold">Professional Legal Services</span>
      </div>

      <!-- Headline -->
      <h1 class="slide-up delay-200 font-display text-5xl sm:text-6xl xl:text-7xl font-black leading-[1.05] text-white">
        LAWYERS
        <span class="block text-gold" style="text-shadow: 0 0 40px rgba(184,147,90,0.3);">DAY</span>
      </h1>
      ...
      <div class="slide-up delay-400 flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <a href="https://wa.me/1234567890?text=I'd%20like%20to%20book%20an%20appointment"
           target="_blank"
        ...
        <!-- Learn more ghost btn -->
        {{-- <a href="#"
           class="inline-flex items-center gap-2 text-white/70 font-body text-sm font-semibold hover:text-gold transition-colors group">
          <span class="border-b border-white/30 group-hover:border-gold pb-px transition-colors">Learn more</span>
          <i class="fas fa-arrow-right text-xs group-hover:translate-x-1 transition-transform"></i>
        </a> --}}
      </div>

      <!-- Social icons -->
      {{-- <div class="slide-up delay-500 flex items-center gap-4 pt-2">
        <span class="text-white/30 text-xs font-body uppercase tracking-widest">Follow us</span>
        <div class="h-px flex-1 max-w-[30px] bg-white/20"></div>
        <a href="#" class="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center text-white/50 hover:border-gold hover:text-gold transition-all text-sm">
    ...
    <div class="slide-up delay-300 flex justify-center lg:justify-end order-1 lg:order-2 py-4">
      ...
      <!-- Outer glow -->
      <div class="absolute inset-y-4 right-4 left-1/2 bg-gold/8 blur-3xl rounded-3xl pointer-events-none hidden lg:block"></div>

      <!-- Frame wrapper -->
      <div class="img-frame-outer img-frame-inner relative w-full max-w-[560px] lg:max-w-none lg:w-[560px] xl:w-[620px]">
        ...
        <div class="img-shimmer relative w-full overflow-hidden rounded-2xl border border-gold/25 shadow-2xl"
          ...
          <div class="absolute bottom-0 left-0 right-0 px-5 py-3 flex items-center justify-between pointer-events-none">
            ...
            <span class="text-gold/60 font-body text-xs">Est. 2004</span>
          </div>
        </div>

        <!-- Accent dots — top right -->
        <div class="absolute -top-4 -right-4 grid grid-cols-3 gap-1 pointer-events-none opacity-40">
          <span class="w-1 h-1 rounded-full bg-gold"></span><span class="w-1 h-1 rounded-full bg-gold"></span><span class="w-1 h-1 rounded-full bg-gold"></span>
          <span class="w-1 h-1 rounded-full bg-gold"></span><span class="w-1 h-1 rounded-full bg-gold"></span><span class="w-1 h-1 rounded-full bg-gold"></span>
          <span class="w-1 h-1 rounded-full bg-gold"></span><span class="w-1 h-1 rounded-full bg-gold"></span><span class="w-1 h-1 rounded-full bg-gold"></span>
        </div>
  ...
  <!-- Bottom gold rule -->
  <div class="absolute bottom-0 left-0 right-0 h-[3px] bg-gradient-to-r from-transparent via-gold to-transparent opacity-50"></div>
