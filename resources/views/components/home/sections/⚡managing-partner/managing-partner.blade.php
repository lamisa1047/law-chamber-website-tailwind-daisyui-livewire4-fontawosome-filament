...
<section class="py-16 lg:py-24 bg-gray-100">
  <div class="max-w-5xl mx-auto px-6">
    ...
    <div class="bg-white border border-gray-100 rounded-[20px] shadow-xl overflow-hidden flex flex-col lg:flex-row">
      ...
      <!-- Left Panel (Dark) — unchanged -->
      <div class="bg-forest flex flex-col items-center text-center px-8 py-10 lg:w-[300px] shrink-0">
        ...
        <div class="w-36 h-36 rounded-full border-[3px] border-gold p-1 mb-6">
          <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=600&q=80"
            alt="Barrister Md. Bodruddoza" class="w-full h-full rounded-full object-cover" />
        </div>
        ...
        <p class="text-white/40 text-xs leading-relaxed">
          Supreme Court of Bangladesh<br>Lincoln's Inn, London
        </p>

      </div>

      <!-- Right Panel — modernised -->
      <div class="flex-1 flex flex-col px-8 sm:px-10 py-10 gap-8">

        <!-- Top: Label + stat pills -->
        <div>
          <p class="text-[10px] font-bold tracking-widest uppercase text-gold mb-4">Credentials & Experience</p>
          <div class="flex flex-wrap gap-2">
            <span
              ...
              <i class="fas fa-briefcase text-[10px] text-gold"></i> 30+ Years Practice
            </span>
            <span
              class="inline-flex items-center gap-1.5 bg-forest/5 border border-forest/10 text-forest text-xs font-medium px-3 py-1.5 rounded-full">
              <i class="fas fa-landmark text-[10px] text-gold"></i> Supreme Court
            </span>
            <span
              class="inline-flex items-center gap-1.5 bg-forest/5 border border-forest/10 text-forest text-xs font-medium px-3 py-1.5 rounded-full">
              <i class="fas fa-graduation-cap text-[10px] text-gold"></i> Lincoln's Inn
            </span>
          </div>
        </div>
        ...
        <ul class="space-y-3">
          <li class="flex items-start gap-3 group">
            <span
              class="mt-[6px] w-5 h-5 rounded-md bg-gold/10 border border-gold/20 flex items-center justify-center shrink-0">
              <i class="fas fa-check text-gold text-[9px]"></i>
            </span>
            <span class="text-gray-600 text-sm leading-relaxed">Of Lincoln's Inn, Barrister-at-Law</span>
          </li>
          <li class="flex items-start gap-3 group">
            <span
              class="mt-[6px] w-5 h-5 rounded-md bg-gold/10 border border-gold/20 flex items-center justify-center shrink-0">
            ...
            <span class="text-gray-600 text-sm leading-relaxed">Senior Advocate, Supreme Court of Bangladesh</span>
          </li>
          <li class="flex items-start gap-3 group">
            <span
              class="mt-[6px] w-5 h-5 rounded-md bg-gold/10 border border-gold/20 flex items-center justify-center shrink-0">
            ...
            <span class="text-gray-600 text-sm leading-relaxed">Former Secretary, Bangladesh Supreme Court Bar
              Association</span>
          </li>
          <li class="flex items-start gap-3 group">
            <span
            ...
            <span class="text-gray-600 text-sm leading-relaxed">Former Deputy Attorney General for Bangladesh</span>
          </li>
          <li class="flex items-start gap-3 group">
            <span
              class="mt-[6px] w-5 h-5 rounded-md bg-gold/10 border border-gold/20 flex items-center justify-center shrink-0">
            ...
            <span class="text-gray-600 text-sm leading-relaxed">Former Secretary, Barristers' Association of
              Bangladesh</span>
          </li>
        </ul>
