        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
            ...
            <div
                ...
                <figure class="relative">
                    <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?w=600&q=80" alt="blog"
                        class="w-full h-44 sm:h-48 object-cover" />
                </figure>
                <div class="card-body p-4 sm:p-5">
                    <div class="text-xs text-gray-400 mb-2 flex items-center gap-2"><i
                            class="far fa-calendar text-gold"></i> March 10, 2026</div>
                    <h3 class="font-display font-bold text-forest leading-tight text-sm sm:text-base">Technology is
                        transforming legal services with AI</h3>
                    <a href="#"
